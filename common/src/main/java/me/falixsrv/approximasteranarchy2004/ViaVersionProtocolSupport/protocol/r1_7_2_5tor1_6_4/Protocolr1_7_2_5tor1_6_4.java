...
this.registerClientboundTransition(ClientboundPackets1_7_2_5.LOGIN,
   ...
   this.registerClientbound(ClientboundPackets1_7_2_5.SET_EQUIPPED_ITEM, new PacketHandlers() { 
        ...
        this.registerClientbound(ClientboundPackets1_7_2_5.RESPAWN, new PacketHandlers() {
	        ...
	        this.registerClientbound(ServerboundPackets1_7_2_5.MOVE_PLAYER_STATUS_ONLY, ClientboundPackets1_6_4.PLAYER_POSITION, wrapper -> {
            ...
            final PacketWrapper setVelocityToZero = PacketWrapper.create(ClientboundPackets1_7_2_5.SET_ENTITY_MOTION, wrapper.user());
        ...
        this.registerClientbound(ServerboundPackets1_7_2_5.MOVE_PLAYER_POS, ClientboundPackets1_6_4.PLAYER_POSITION, wrapper -> {
            final PlayerInfoStorage playerInfoStorage = wrapper.user().get(PlayerInfoStorage.class);
            final boolean supportsFlags = wrapper.user().getProtocolInfo().protocolVersion().newerThanOrEqualTo(ProtocolVersion.v1_8);
        ...
        this.registerClientbound(ServerboundPackets1_7_2_5.MOVE_PLAYER_ROT, CilentboundPackets1_6_4.PLAYER_POSITION, wrapper -> {
            final PlayerInfoStorage playerInfoStorage = wrapper.user().get(PlayerInfoStorage.class);
            final boolean supportsFlags = wrapper.user().getProtocolInfo().protocolVersion().newerThanOrEqualTo(ProtocolVersion.v1_8);
        ...
        this.registerClientbound(ClientboundPackets1_7_2_5.PLAYER_POSITION, new PacketHandlers() {
            @Override
            public void register() {
                map(Types.DOUBLE); // x
